    ...
    if (isLoggedIn) {
      ...
      const variantId =
        ...
        (await resolveVariantId(
          ...
          customization.colorName ?? customization.color,
          customization.size,
        ));
      if (!variantId) {
        ...
        const newItem: CartItem = {
          ...
          product: {
            ...
            colors: [
              {
                name: customization.colorName ?? "Custom",
                hex: customization.color,
                available: true,
              },
            ],
            available: true,
  ...
  return (
    <div className="min-h-screen bg-[#0A0A0A]">
      ...
      <section id="uniformes">
        <UniformCustomizer
          onAddToCart={(c: unknown) => {
            const customization = c as {
              mockup?: {
                id?: string;
                name?: string;
                price?: number;
            ...
            const newItem: CartItem = {
              ...
              product: {
                ...
                basePrice:
                  customization.mockup?.price ?? customization.totalPrice,
                images: [customization.mockup?.image ?? ""],
                sizes: [customization.size as "M"],
                colors: [
                  { name: "Custom", hex: customization.color, available: true },
                ],
                available: true,
                featured: false,
                isNew: false,
      ...
      <section className="py-24 bg-[#0A0A0A] relative overflow-hidden">
        ...
        <div className="max-w-[1400px] mx-auto px-6 relative z-10 text-center">
          ...
          <p className="text-white/50 max-w-xl mx-auto mb-10 text-sm leading-relaxed">
            Escolha entre nossa linha de moda personalizada ou crie seu uniforme
            exclusivo com arte própria.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <button
              onClick={() =>
                document
                  .getElementById("uniformes")
                  ?.scrollIntoView({ behavior: "smooth" })
              }
